...
namespace ClientProgram
{
    public class ProgramClient
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            string serverIp = settingsMng.ReadSetting(ClientConfig.serverIPConfigKey);
            string clientIp = settingsMng.ReadSetting(ClientConfig.ClientIPConfigKey);
            int serverPort = int.Parse(settingsMng.ReadSetting(ClientConfig.serverPortconfigKey));
            int clientPort = int.Parse(settingsMng.ReadSetting(ClientConfig.ClientPortconfigKey));
